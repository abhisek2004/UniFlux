...
const TimetableView: React.FC = () => {
  ...
  // ... (Your semesterTimetables data stays exactly the same)
  const semesterTimetables = {
    1: [{ day: 'Monday', timeSlots: [{ time: '9:00-10:00', subjectCode: 'MA101', subjectName: 'Mathematics I', teacherName: 'Dr. Sharma' }, { time: '10:00-11:00', subjectCode: 'PH101', subjectName: 'Physics I', teacherName: 'Dr. Gupta' }, { time: '11:00-12:00', subjectCode: 'CH101', subjectName: 'Chemistry I', teacherName: 'Dr. Verma' }, { time: '1:00-2:00', subjectCode: 'EG101', subjectName: 'Engineering Graphics', teacherName: 'Prof. Singh' }, { time: '2:00-3:00', subjectCode: 'CS101', subjectName: 'Programming Fundamentals', teacherName: 'Dr. Kumar' }] }],
    2: [{ day: 'Monday', timeSlots: [{ time: '9:00-10:00', subjectCode: 'MA201', subjectName: 'Mathematics II', teacherName: 'Dr. Sharma' }, { time: '10:00-11:00', subjectCode: 'PH201', subjectName: 'Physics II', teacherName: 'Dr. Gupta' }, { time: '11:00-12:00', subjectCode: 'CS201', subjectName: 'Data Structures', teacherName: 'Dr. Patel' }, { time: '1:00-2:00', subjectCode: 'EC201', subjectName: 'Digital Electronics', teacherName: 'Prof. Jain' }, { time: '2:00-3:00', subjectCode: 'CS202', subjectName: 'Object Oriented Programming', teacherName: 'Dr. Kumar' }] }],
  ...
  // ... (Your getTimetableData logic stays exactly the same)
  ...
  const getTimeSlotColor = (subjectCode: string) => {
    const colors = ['bg-blue-100 text-blue-800 border-blue-200', 'bg-green-100 text-green-800 border-green-200', 'bg-purple-100 text-purple-800 border-purple-200', 'bg-yellow-100 text-yellow-800 border-yellow-200', 'bg-pink-100 text-pink-800 border-pink-200', 'bg-indigo-100 text-indigo-800 border-indigo-200'];
  ...
  return (
    <div className="space-y-6">
      {/* ADDED THIS CSS BLOCK FOR PRINTING */}
      ...
      {/* WRAPPED THE TIMETABLE GRID IN THIS DIV WITH ID */}
      <div id="timetable-to-print">
        {/* Timetable Grid */}
